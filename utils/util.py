...
from baxter.baxter_mugs import BaxterConfig as BaxterConfigMug
from baxter.baxter_toy import BaxterConfig as BaxterConfigToy
...
class RCNN(object):
    ...
    def __init__(self, plot_mode=False):
        self.model_dir = '/home/msieb/projects/gps/experiments/baxter_reaching/data_files'
        class InferenceConfig(BaxterConfig):
            ...
            TARGET_IDS = [ 4]
        class MugInferenceConfig(BaxterConfigMug):
            MODEL_PATH = "/home/msieb/projects/Mask_RCNN/weights/baxter20180718T1859/mask_rcnn_baxter_0003.h5"
            GPU_COUNT = 1
            IMAGES_PER_GPU = 1
            # CLASS_NAMES = ['BG', 'green_mug', 'red_mug', 'brown_mug', 'black_mug', 'robot']
            CLASS_NAMES = ['BG', 'mug', 'robot']

            TARGET_IDS = [1]

        class ToyInferenceConfig(BaxterConfigToy):
            MODEL_PATH = "/home/msieb/projects/Mask_RCNN/logs/baxter20180720T0419/mask_rcnn_baxter_0003.h5"
            GPU_COUNT = 1
            IMAGES_PER_GPU = 1
            # CLASS_NAMES = ['BG', 'green_mug', 'red_mug', 'brown_mug', 'black_mug', 'robot']
            CLASS_NAMES = ['BG', 'toy', 'hand', 'robot']

            TARGET_IDS = [1]
        # self.tcn = load_tcn_model('/media/msieb/1e2e903d-5929-40bd-a22a-a94fd9e5bcce/tcn_data/experiments/ltcn/trained_models/tcn-no-depth-sv/ltcn-inc-epoch-8.pk')
        inference_config = ToyInferenceConfig()
        self.model_path = inference_config.MODEL_PATH
        with tf.device('/device:GPU:2'):
            self.rcnn = modellib.MaskRCNN(mode='inference', model_dir=self.model_dir,
        ...
        self.target_ids = inference_config.TARGET_IDS
