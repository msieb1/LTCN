...
class TCNModel(EmbeddingNet):
    def __init__(self, inception):  
        ...
        self.FullyConnectedConcat = Dense(64, 32)
        self.FullyConnectedPose = Dense(32, 4)
