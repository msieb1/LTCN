...
from utils.util import (MultiViewTripletTransitionBuilder, distance, Logger, ensure_folder, collate_fn)
...
def get_args():
    ...
    parser.add_argument('--model-folder', type=str, default='/home/msieb/experiments/tcn_data/pressing_orange_button_w_transition/trained_models')
    ...
    parser.add_argument('--train-directory', type=str, default='/home/msieb/experiments/tcn_data/pressing_orange_button_w_transition/videos/train/')
    parser.add_argument('--validation-directory', type=str, default='/home/msieb/experiments/tcn_data/pressing_orange_button_w_transition/videos/valid/')
    parser.add_argument('--labels-train-directory', type=str, default='/home/msieb/experiments/tcn_data/pressing_orange_button_w_transition/audio/train/')
    parser.add_argument('--labels-validation-directory', type=str, default='/home/msieb/experiments/tcn_data/pressing_orange_button_w_transition/audio/valid/')
...
args = get_args()
print(args)
builder = MultiViewTripletTransitionBuilder
...
def main():
    ...
    optimizer = optim.Adam(tcn.parameters(), lr=args.lr_start)
